...
from percival_detector.control.standalone import PercivalStandalone
...
def main():
    ...
    percival_detector.setup_control_channel(args.control)

    # Initialise the status endpoint
    percival_detector.setup_status_channel(args.status)

    # Startup the IpcReactor
    percival_detector.start_reactor()
