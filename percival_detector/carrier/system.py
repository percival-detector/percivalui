...
An instance is initialised with a percival_detector.carrier.txrx.TxRx object and
...
from percival_detector.carrier.errors import PercivalSystemCommandError
...
class SystemCommand(object):
    ...
    def _get_command_msg(self, cmd):
        ...
        :type  cmd: SystemCmd
        :returns: percival_detector.carrier.txrx.TxMessage
        """
