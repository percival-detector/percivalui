...
from percival_detector.carrier.encoding import DATA_ENCODING, NUM_BYTES_PER_MSG, END_OF_MESSAGE
from percival_detector.carrier.encoding import decode_message
from percival_detector.carrier.errors import PercivalCommsError, PercivalProtocolError
...
class TxRx(object):
    ...
    def tx_msg(self, msg):
        """Transmit a single message of :const:`percival_detector.carrier.encoding.NUM_BYTES_PER_MSG` bytes to the Carrier Board
