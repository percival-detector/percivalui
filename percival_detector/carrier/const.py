...
# CONTROL_CHANNELS and MONITORING_CHANNELS correspond to control_settings and monitoring_settings
# in the documentation.
HEADER_SETTINGS_LEFT = UARTBlock(1, 1, 0x0000)
CONTROL_CHANNELS_LEFT = UARTBlock(1, 4, 0x0001)
MONITORING_CHANNELS_LEFT = UARTBlock(1, 4, 0x0005)
HEADER_SETTINGS_BOTTOM = UARTBlock(1, 1, 0x0009)
CONTROL_CHANNELS_BOTTOM = UARTBlock(52, 4, 0x000A)
MONITORING_CHANNELS_BOTTOM = UARTBlock(84, 4, 0x00DA)
HEADER_SETTINGS_CARRIER = UARTBlock(1, 1, 0x022A)
CONTROL_CHANNELS_CARRIER = UARTBlock(1, 4, 0x022B)
MONITORING_CHANNELS_CARRIER = UARTBlock(4, 4, 0x022F)
HEADER_SETTINGS_PLUGIN = UARTBlock(1, 1, 0x023F)
CONTROL_CHANNELS_PLUGIN = UARTBlock(1, 4, 0x0240)
MONITORING_CHANNELS_PLUGIN = UARTBlock(1, 4, 0x0244)
...
READBACK_CONTROL_CHANNELS_LEFT = UARTBlock(1, 1, 0x0371)
READBACK_MONITORING_CHANNELS_LEFT = UARTBlock(1, 1, 0x0372)
READBACK_HEADER_SETTINGS_BOTTOM = UARTBlock(1, 1, 0x0373)
READBACK_CONTROL_CHANNELS_BOTTOM = UARTBlock(1, 1, 0x0374)
READBACK_MONITORING_CHANNELS_BOTTOM = UARTBlock(1, 1, 0x0375)
READBACK_HEADER_SETTINGS_CARRIER = UARTBlock(1, 1, 0x0376)
READBACK_CONTROL_CHANNELS_CARRIER = UARTBlock(1, 1, 0x0377)
READBACK_MONITORING_CHANNELS_CARRIER = UARTBlock(1, 1, 0x0378)
READBACK_HEADER_SETTINGS_PLUGIN = UARTBlock(1, 1, 0x0379)
READBACK_CONTROL_CHANNELS_PLUGIN = UARTBlock(1, 1, 0x037A)
READBACK_MONITORING_CHANNELS_PLUGIN = UARTBlock(1, 1, 0x037B)
