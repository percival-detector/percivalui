...
from percival_detector.log import log, get_exclusive_file_logger
from percival_detector.carrier import const
from percival_detector.carrier.registers import UARTRegister, generate_register_maps
from percival_detector.carrier.settings import BoardSettings
from percival_detector.carrier.txrx import TxRxContext, hexify
from percival_detector.carrier.channels import ControlChannel
...
class ReadMonitors(object):
    def __init__(self, txrx, uart_block, ini_params, board_type):
        ...
        :param txrx:
        :param uart_block:
        :type: :obj:`percival_detector.carrier.const.UARTBlock`
        """
        self._txrx = txrx
    ...
    def read_monitors_devices(self):
        ...
        :class:`percival_detector.carrier.register.ReadValueMap` objects.

        :returns: list of :class:`percival_detector.carrier.register.ReadValueMap` objects.
        :rtype: list
        """
        response = self._txrx.send_recv_message(self._cmd_msg)
