...
echo "change biases from standard-after-PowON-status to FSI10_FixGnHi"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f FSI10_FixGnHi -n 2 -d 500

echo "Load ADC25MHz, PLL125MHz, 3T,PGAB SequentialMode, 10 Images, 12ms integration"
...
echo  "DONE"
echo  "PLL125MHz, ADC25MHz, 10img, 12ms, 3T, PGAB"
