...
echo "change biases from standard-after-PowON-status to FSI10-Basic-status"
percival-hl-scan-setpoints -i 08_1_CurrentBiases_ON_ready3T -f FSI10_Basic -n 2 -d 500
...
echo  "VRST,PGAB,FSI10_Basic (FSI10) VRST,PGAB"
