...
echo "change readout-settings to fixGn(VeryHi)-status"
# note that notwithstanding the name this does not change clk or Synchr/FEL status
percival-hl-configure-chip-readout-settings -i ./DESY/W3C3/config/02_Chip_Readout_Settings/ChipReadoutSettings_N18_PGA6_Gn0_ADC25MHz_PLL120MHz_SEQUENTIAL.ini
...
echo  "fixGn(VeryHi) , 10Img, 7/7ADC"
